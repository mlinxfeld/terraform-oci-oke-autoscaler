# OCI Container Engine for Kubernetes (aka OCI OKE) with Autoscaler

## Project description

In this repository, I have documented my hands on experience with Terrafrom for the purpose of Container Engine for Kubernetes (aka OCI OKE) deployment with Autoscaler. This set of HCL based Terraform files which can customized according to any requirements.  

## Topology Diagram 

With the usage of this example HCL code you can build topology documented by diagram below. This topology is extremly simplified for education purposes and rather cannot be used for production implementations. 

![](terraform-oci-oke-autoscaler.png)

## How to use code 

### Deploy Using Oracle Resource Manager

1. Click [![Deploy to Oracle Cloud](https://oci-resourcemanager-plugin.plugins.oci.oraclecloud.com/latest/deploy-to-oracle-cloud.svg)](https://cloud.oracle.com/resourcemanager/stacks/create?region=home&zipUrl=https://github.com/mlinxfeld/terraform-oci-oke-autoscaler/releases/latest/download/terraform-oci-oke-autoscaler-stack-latest.zip)
...
```
[opc@terraform-server ~]$ git clone https://github.com/mlinxfeld/terraform-oci-oke-autoscaler.git
Cloning into 'terraform-oci-oke-autoscaler'...
...
[opc@terraform-server ~]$ cd terraform-oci-oke-autoscaler/

[opc@terraform-server terraform-oci-oke-autoscaler]$ ls -latr
...
-rw-r--r--@  1 opc opc 690081 Jun 11 10:54 terraform-oci-oke-autoscaler.jpg
...
```
[opc@terraform-server terraform-oci-oke-autoscaler]$ export PATH=$PATH:/home/opc/terraform

[opc@terraform-server terraform-oci-oke-autoscaler]$ terraform --version
...
```
[opc@terraform-server terraform-oci-oke-autoscaler]$ vi setup_oci_tf_vars.sh
...
[opc@terraform-server terraform-oci-oke-autoscaler]$ source setup_oci_tf_vars.sh
```
...
```
[opc@terraform-server terraform-oci-oke-autoscaler]$ terraform init 
...
```
[opc@terraform-server terraform-oci-oke-autoscaler]$ terraform apply
...
```
[opc@terraform-server terraform-oci-oke-autoscaler]$ terraform destroy -auto-approve
